...
function showCreditCardPaymentMenu() {
    var _a;
    (_a = (0, PaymentStrategy_1.PaymentStrategy)("creditcard")) === null || _a === void 0 ? void 0 : _a.execute();
}
function showBankDraftPaymentMenu() {
    var _a;
    (_a = (0, PaymentStrategy_1.PaymentStrategy)("bankdraft")) === null || _a === void 0 ? void 0 : _a.execute();
}
function showOnlinePaymentMenu() {
    var _a;
    (_a = (0, PaymentStrategy_1.PaymentStrategy)("onlinepayment")) === null || _a === void 0 ? void 0 : _a.execute();
}
function showOfflinePaymentMenu() {
    var _a;
    (_a = (0, PaymentStrategy_1.PaymentStrategy)("offlinepayment")) === null || _a === void 0 ? void 0 : _a.execute();
}
